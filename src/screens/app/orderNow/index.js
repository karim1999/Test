            ...
            <AppTemplate navigation={nav} name="اطلب الان">
                <View style={{ flex: 1, flexDirection: 'row', justifyContent: 'center' }}>
                    <View style={{ width: '90%',flexDirection:'column' }}>
                        <ListCard header={'حدد مكان الاستلام'} footer={'اختر موقع استلام الشحنه'} rightIcon={'map'}  />
                        <ListCard header={'حدد مكان التسليم'} footer={'اختر موقع تسليم الشحنه'} rightIcon={'location-arrow'}  />
                        <ListCard header={'حددوقت التسليم'} footer={'اضغط هنا لاختيار وقت التسليم'} rightIcon={'clock'} />
                        <ListCard header={'حدد نوع السياره'} footer={'بيك أب - سيدان'} rightIcon={'car-side'} />
                    </View>
                </View>
